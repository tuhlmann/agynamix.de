...
import {getYouTubeIFrameSrc, shouldTransform, getTimeValueInSeconds} from "../get-youtube-html"
...
cases(
  ...
  },
  {
    ...
    "with list and time params": {
      ...
      iframe: "https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ?rel=0&list=123&start=23"
    },
    "full url": {
    ...
    "full url with list param": {
      ...
      iframe: "https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ?rel=0&list=123"
    },
    "full url with list and time param": {
      url: "https://youtube.com/watch?v=dQw4w9WgXcQ&t=123",
      iframe: "https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ?rel=0&start=123"
    },
    "time with seconds": {
      url: "youtu.be/dQw4w9WgXcQ?t=23s",
      iframe: "https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ?rel=0&start=23"
    }
  }
)
