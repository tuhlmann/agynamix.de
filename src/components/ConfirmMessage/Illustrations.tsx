...
export const PleaseConfirmIllustration = (
  <div
    css={css`
      ...
      text {
        animation: ${NotificationFadeIn} 1.25s 250ms cubic-bezier(0.19, 1, 0.22, 1) 1;
      }
      .cursor {
        animation: ${TextCopyRollOut} 1.5s cubic-bezier(0.19, 1, 0.22, 1) 1;
      }
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g mask="url(#welcome-b)" className="sign">
          <rect width="13" height="100" x="44" fill="#B4BDDC" rx="1" className="slope" />
          <ellipse cx="50" cy="100" fill="url(#welcome-c)" fillRule="nonzero" rx="82" ry="43" />
          <path
            className="grass"
          ...
          />
          <rect className="sheet" width="100" height="48" y="9" fill={theme.brand.primary} rx="5" />
          <rect className="sheet" width="94" height="42" x="3" y="12" stroke="#FFF" opacity="0.5" rx="3" />
          <text fill="#FFF" fontFamily={fonts.regular} fontSize="14.3" fontWeight="500">
            <tspan x="13.713" y="39">
              WELCOME
            </tspan>
          </text>
  ...
  >
    ...
    >
      ...
      <g fill="none" fillRule="evenodd" transform="translate(0 -17)">
        ...
        <ellipse className="shadow" cx="40" cy="100" fill="url(#welcome-c)" fillRule="nonzero" rx="60" ry="60" />
        <g className="pieces" fill="#CFD6E9" fillRule="nonzero" transform="translate(18 77)">
