...
import {TextExtLink} from "../components/Header"

## <a name="dsgvo_de">Datenschutzerklärung</a> (<TextExtLink href="#dsgvo_en">English Version</TextExtLink>)
...
## <a name="dsgvo_en">Privacy Policy</a> (<TextExtLink href="#dsgvo_de">Deutsche Version</TextExtLink>)
